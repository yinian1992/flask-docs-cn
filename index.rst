...
:ref:`tutorial` 比快速入门更详细地介绍了如何用 Flask 创建一个完整的
应用（虽然很小）。深入了解 Flask 内部细节，请查阅 :ref:`api`
文档。:ref:`patterns` 章节介绍了一些常见模式。

Flask 依赖于两个外部库： `Jinja2`_ 模板引擎和 `Werkzeug`_ WSGI 工具
